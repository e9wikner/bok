...
INK2_SECTIONS = (
    DeclarationSectionDefinition(
        ...
        (
            DeclarationRowDefinition(
                "1.1",
                "Överskott av näringsverksamhet",
                value_key="taxable_result_positive",
            ),
            DeclarationRowDefinition(
                "1.2",
                "Underskott av näringsverksamhet",
                value_key="taxable_result_negative",
            ),
            DeclarationRowDefinition(
                "1.3",
    ...
    DeclarationSectionDefinition(
        ...
        (
            ...
            DeclarationRowDefinition(
                "1.5", "Negativt underlag för särskild löneskatt på pensionskostnader"
            ),
        ),
    ),
    DeclarationSectionDefinition(
        ...
        (
            DeclarationRowDefinition(
                "1.6",
                "Underlag för avkastningsskatt 15 %. Försäkringsföretag m.fl. Avsatt till pensioner",
            ),
            DeclarationRowDefinition(
                "1.7",
                "Underlag för avkastningsskatt 30 %. Försäkringsföretag m.fl. Utländska kapitalförsäkringar",
            ),
        ),
    ),
    DeclarationSectionDefinition(
    ...
    DeclarationSectionDefinition(
        ...
        (
            DeclarationRowDefinition(
                "1.10", "Småhus/ägarlägenhet: tomtmark, byggnad under uppförande"
            ),
            DeclarationRowDefinition(
                "1.11", "Hyreshus: tomtmark, bostäder under uppförande"
            ),
            DeclarationRowDefinition("1.12", "Hyreshus: lokaler"),
            DeclarationRowDefinition(
                "1.13",
                "Industri/elproduktionsenhet, värmekraftverk (utom vindkraftverk)",
            ),
...
INK2S_SECTIONS = (
    DeclarationSectionDefinition(
        ...
        (
            ...
            DeclarationRowDefinition(
                ...
                sign="-",
                value_key="accounting_result_negative",
            ),
        ),
    ),
    DeclarationSectionDefinition(
        ...
        (
            DeclarationRowDefinition(
                "4.3a",
                "Bokförda kostnader som inte ska dras av: skatt på årets resultat",
                ("7651",),
                "+",
            ),
            DeclarationRowDefinition(
                "4.3b",
                "Bokförda kostnader som inte ska dras av: nedskrivning av finansiella tillgångar",
                sign="+",
            ),
            DeclarationRowDefinition(
                "4.3c",
                "Bokförda kostnader som inte ska dras av: andra bokförda kostnader",
                ("7653",),
                "+",
            ),
            DeclarationRowDefinition(
                "4.4a",
                "Kostnader som ska dras av men som inte ingår i det redovisade resultatet: lämnade koncernbidrag",
                sign="-",
            ),
            DeclarationRowDefinition(
                "4.4b",
                "Kostnader som ska dras av men som inte ingår i det redovisade resultatet: andra ej bokförda kostnader",
                sign="-",
            ),
            DeclarationRowDefinition(
                "4.5a",
                "Bokförda intäkter som inte ska tas upp: ackordsvinster",
                sign="-",
            ),
            DeclarationRowDefinition(
                "4.5b", "Bokförda intäkter som inte ska tas upp: utdelning", sign="-"
            ),
            DeclarationRowDefinition(
                "4.5c",
                "Bokförda intäkter som inte ska tas upp: andra bokförda intäkter",
                ("7754",),
                "-",
            ),
            DeclarationRowDefinition(
                "4.6a",
                "Intäkter som ska tas upp men som inte ingår i det redovisade resultatet: schablonintäkt på kvarvarande periodiseringsfonder",
                ("7654",),
                "+",
            ),
            DeclarationRowDefinition(
                "4.6b",
                "Intäkter som ska tas upp men som inte ingår i det redovisade resultatet: schablonintäkt på investeringsfonder",
                sign="+",
            ),
            DeclarationRowDefinition(
                "4.6c",
                "Intäkter som ska tas upp men som inte ingår i det redovisade resultatet: mottagna koncernbidrag",
                sign="+",
            ),
            DeclarationRowDefinition(
                "4.6d",
                "Intäkter som ska tas upp men som inte ingår i det redovisade resultatet: intäkt negativ justerad anskaffningsutgift",
                sign="+",
            ),
            DeclarationRowDefinition(
                "4.6e",
                "Intäkter som ska tas upp men som inte ingår i det redovisade resultatet: andra ej bokförda intäkter",
                sign="+",
            ),
        ),
    ),
    DeclarationSectionDefinition(
        ...
        (
            DeclarationRowDefinition(
                "4.7a", "Avyttring av delägarrätter: bokförd vinst", sign="-"
            ),
            DeclarationRowDefinition(
                "4.7b", "Avyttring av delägarrätter: bokförd förlust", sign="+"
            ),
            DeclarationRowDefinition(
                "4.7c",
                "Avyttring av delägarrätter: uppskov med kapitalvinst enligt blankett N4",
                sign="-",
            ),
            DeclarationRowDefinition(
                "4.7d",
                "Avyttring av delägarrätter: återfört uppskov av kapitalvinst enligt blankett N4",
                sign="+",
            ),
            DeclarationRowDefinition(
                "4.7e",
                "Avyttring av delägarrätter: kapitalvinst för beskattningsåret",
                sign="+",
            ),
            DeclarationRowDefinition(
                "4.7f",
                "Avyttring av delägarrätter: kapitalförlust som ska dras av",
                sign="-",
            ),
            DeclarationRowDefinition(
                "4.8a", "Andel i handelsbolag: bokförd intäkt/vinst", sign="-"
            ),
            DeclarationRowDefinition(
                "4.8b",
                "Andel i handelsbolag: skattemässigt överskott enligt N3B",
                sign="+",
            ),
            DeclarationRowDefinition(
                "4.8c", "Andel i handelsbolag: bokförd kostnad/förlust", sign="+"
            ),
            DeclarationRowDefinition(
                "4.8d",
                "Andel i handelsbolag: skattemässigt underskott enligt N3B",
                sign="-",
            ),
            DeclarationRowDefinition(
                "4.9",
                "Skattemässig justering av bokfört resultat för avskrivning på byggnader och annan fast egendom samt vid restvärdesavskrivning",
                sign="+",
            ),
            DeclarationRowDefinition(
                "4.10",
            ...
            DeclarationRowDefinition(
                "4.11", "Skogs-/substansminskningsavdrag", sign="-"
            ),
            DeclarationRowDefinition(
                "4.12", "Återföringar vid avyttring av fastighet", sign="+"
            ),
            DeclarationRowDefinition(
                "4.13", "Andra skattemässiga justeringar av resultatet", sign="+"
            ),
            DeclarationRowDefinition(
                "4.14a",
                "Underskott: outnyttjat underskott från föregående år",
                sign="-",
            ),
            DeclarationRowDefinition(
                "4.14b",
                "Underskott: reduktion av underskott med hänsyn till exempelvis ägarförändring eller ackord",
                sign="+",
            ),
            DeclarationRowDefinition(
                "4.15", "Överskott (flyttas till p. 1.1)", ("7670",), "(+) ="
            ),
            DeclarationRowDefinition(
                "4.16",
                "Underskott (flyttas till p. 1.2)",
                sign="(-) =",
                value_key="taxable_result_negative",
            ),
        ),
    ...
    DeclarationSectionDefinition(
        ...
        (
            ...
            DeclarationRowDefinition(
                "JA/NEJ", "Årsredovisningen har varit föremål för revision"
            ),
        ),
    ),
)
...
class INK2DeclarationService:
    ...
    def build(self, fiscal_year_id: str) -> Dict:
        ...
        return {
            ...
            "sections": {
                tab_id: [
                    self._build_section(
                        section, declaration, accounting_result, taxable_result
                    )
    ...
    def _accounting_result(self, declaration: SRUDeclaration) -> int:
        ink2r_result = declaration.get_field_value(
            "7450"
        ) - declaration.get_field_value("7550")
        computed_result = sum(
            declaration.get_field_value(field) for field in INCOME_RESULT_FIELDS
        ) - sum(declaration.get_field_value(field) for field in EXPENSE_RESULT_FIELDS)
