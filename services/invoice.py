...
class InvoiceService:
    ...
    def create_booking_for_invoice(
        self, invoice_id: str, period_id: str, actor: str = "system"
    ) -> str:
        ...
        self.audit.log(
            ...
            action="booked",
            actor=actor,
            payload={"voucher_id": voucher.id, "period_id": period_id},
        )
    ...
    def _create_payment_voucher(
        self, invoice: Invoice, payment: Payment, period_id: str, actor: str
    ) -> None:
    ...
    def create_credit_note(
        ...
        original_rate = (
            invoice.vat_amount / invoice.amount_ex_vat
            if invoice.amount_ex_vat > 0
            else 0
        )
    ...
    def _create_credit_voucher(
        self, invoice: Invoice, credit: CreditNote, period_id: str, actor: str
    ) -> None:
