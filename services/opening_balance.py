...
class OpeningBalanceService:
    ...
    def update_opening_balances(self, fiscal_year_id: str, actor: str = "system") -> Optional[Voucher]:
        ...
        if ib_voucher:
            return self._update_ib_voucher(ib_voucher, rows_data, fy.start_date.year, actor)
        else:
            return self._create_ib_voucher(fiscal_year_id, first_period.id, fy.start_date, rows_data, actor)
    ...
    def _calculate_prior_year_balances(self, prev_fiscal_year_id: str) -> Dict[str, int]:
        vouchers, _ = self.vouchers.list_all(fiscal_year_id=prev_fiscal_year_id, status="posted")
